...
export interface ApiSentenceSentence extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    kz_sentence: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ru_sentence: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWordWord extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isPliral: Schema.Attribute.String;
    kz_word: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::word.word'> &
      Schema.Attribute.Private;
    part_of_speech: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    ru_word: Schema.Attribute.String & Schema.Attribute.Required;
    sentences: Schema.Attribute.Relation<
      'manyToMany',
      'api::sentence.sentence'
    >;
    updatedAt: Schema.Attribute.DateTime;
